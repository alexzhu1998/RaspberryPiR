...
options(warn = 1)
base::assign(".ExTimings", "RaspberryPiR-Ex.timings", pos = 'CheckExEnv')
...
base::cat("RaspberryPiR-package", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
